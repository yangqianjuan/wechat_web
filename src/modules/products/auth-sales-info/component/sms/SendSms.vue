<template>
  <div class="sms-code">
    <van-button :disabled="button.disable" @click.stop="sendSms">{{ sending ? button.desc: button.normalDeac }}</van-button>
  </div>
</template>
<script>
let timeNum = 60;
